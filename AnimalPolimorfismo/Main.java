...
public class Main {
    public static void main(String[] args) {
        int opcao = Integer.parseInt(JOptionPane.showInputDialog("[1] - Elefante | [2] - Cachorro | [3] - Gato | [4] - Jaguar\n\nDIGITE QUAL ANIMAL DESEJA CADASTRAR: "));
        if(opcao != 1 && opcao != 2 && opcao != 3 && opcao != 4) System.exit(0);
        ...
        else if(opcao == 3) apresentaAnimal(new Gato(nome, cor, peso));
