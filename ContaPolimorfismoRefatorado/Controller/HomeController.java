package ContaPolimorfismoRefatorado.Controller;
import ContaPolimorfismoRefatorado.Entidades.*;
import ContaPolimorfismoRefatorado.Factory.FactoryCompartilhada;
import ContaPolimorfismoRefatorado.Pattern.Pattern;
import javax.swing.*;
    ...
    public void cadastraContas(){
        ...
        do{
            Object opcao = FactoryCompartilhada.exibeMenuRecebeResposta(
                    "SELECIONE O TIPO DE CONTA: ", "MENU", new Object[]{"NENHUM", "CONTA POUPANCA", "CONTA CORRENTE"}
            );
